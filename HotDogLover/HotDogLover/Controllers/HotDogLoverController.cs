...
namespace HotDogLover.Controllers
{
    public class HotDogLoverController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Bio,pastPark,ImageUrl,CurrentDog,LastPark,LastParkDate,Score")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Bio,pastPark,ImageUrl,CurrentDog,LastPark,LastParkDate,Score")] Contact contact)
        {
            if (ModelState.IsValid)
            {
